...
{
    public class J1APIController : ApiController
    {
        /// <summary>
        ...
        /// </returns>
        /// <example>
        /// GET: api/J1API/GetCalories/4/4/4/4 -> "0"
        /// GET: api/J1API/GetCalories/1/2/3/4 -> "691"
        /// </example>
        [HttpGet]
        [Route("api/J1API/GetCalories/{burger}/{drink}/{side}/{dessert}")]
        public string GetCalories(int? burger, int? drink, int? side, int? dessert)
        {
            ...
            if (burger < 1 || burger > 4 || drink < 1 || drink > 4 || side < 1 || side > 4 || dessert < 1 || dessert > 4 || burger == null || drink == null || side == null || dessert == null) {
                return "unknown";
             }
            else
            {
